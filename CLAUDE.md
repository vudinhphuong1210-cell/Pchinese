...
| ------------------------------------- | ------------------------- | --------------------------------------------- |
| Java classes, React components        | PascalCase                | `LessonProgressService`, `PracticePlayer.tsx` |
| Java methods, variables, TS utilities | camelCase                 | `calculateNextReview`, `formatDuration.ts`    |
...
| `any` in TypeScript                     | Removes type safety at API boundaries                      | Define concrete types and DTOs               |
...
4. Update the React feature using typed API clients; do not duplicate backend rules.
