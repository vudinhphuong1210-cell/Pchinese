...
- [ ] T015 [US1] Implement contract-bound conversation/message client, scenario chooser, composer and bounded reply UI in frontend/src/api/aiBuddy.js and frontend/src/features/ai-buddy/ConversationPanel.jsx.
